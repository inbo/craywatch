...
<div style="display: flex; align-items: flex-start; gap: 15px;">
  <img src="../../../assets/images/virilis_nieuwsbrief.jpg" width="20%" alt="Virilis Nieuwsbrief" />
  <p>
...
<div style="display: flex; align-items: flex-start; gap: 20px;">
  <img src="../../../assets/images/foto_vrijwilliger1.jpg" width="25%" alt="vrijwilliger 1" />
  <p>
...
<div style="display: flex; align-items: flex-start; gap: 20px;">
  <img src="../../../assets/images/foto_vrijwilliger2.jpg" width="25%" alt="vrijwilliger 2" />
  <p>
